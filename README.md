...
- Amazon => untuk membantu memperbaiki program yang sulit untuk diperbaiki 
...
amazon :
perbaiki error dan warning yang ada di bagian admin dikarenakan di bagian tersebut sulit untuk diperbaiki
